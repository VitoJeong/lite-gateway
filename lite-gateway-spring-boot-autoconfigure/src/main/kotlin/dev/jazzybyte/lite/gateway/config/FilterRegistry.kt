...
class FilterRegistry {
    ...
    private fun initializeFilterClasses(): Map<String, Class<out GatewayFilter>> {
        ...
        try {
            log.info { "Starting filter discovery in package: $packageName" }
            ...
            val discoveryTime = System.currentTimeMillis() - discoveryStartTime
            val errorMessage = "Failed to discover filter classes in package '$packageName' after ${discoveryTime}ms"
